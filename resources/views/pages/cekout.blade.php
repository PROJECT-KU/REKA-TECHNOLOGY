                ...
                <div class="order-items">
                  <div class="order-item">
                    <div class="order-item-image">
                      <img src="{{ 'niceshop/assets/img/product/product-1.webp' }}" alt="Product" class="img-fluid">
                    </div>
                  ...
                  <div class="order-item">
                    <div class="order-item-image">
                      <img src="{{ 'niceshop/assets/img/product/product-2.webp' }}" alt="Product" class="img-fluid">
                    </div>
                    <div class="order-item-details">
